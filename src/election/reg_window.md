...
However, the election board should clearly announce any change as it may affect
the results.

If the election board wants to commit to a given window they should explicitly
